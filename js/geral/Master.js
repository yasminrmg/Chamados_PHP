var Master = {
    validaFormulario: function(idPai) {
        ...
        $(
            "#" +
                idPai +
                ' input[type="password"].obrigatorio:visible, #' +
                idPai +
                ' input[type="text"].obrigatorio:visible, #' +
                idPai +
                " select.obrigatorio:visible, #" +
                idPai +
                " textarea.obrigatorio:visible"
        ...
        $(
            "#" + idPai + ' label.obrigatorio > input[type="checkbox"]:visible'
        ).each(function(indice, elemento) {
            $(elemento).removeClass("nao-preenchido");
        ...
        $(
            "#" + idPai + ' span.obrigatorio > input[type="checkbox"]:visible'
        ).each(function(indice, elemento) {
            $(elemento).removeClass("nao-preenchido");
        ...
        $("#" + idPai + " .div_obrigatoria:visible").each(function(
            indice,
            elemento
        ) {
            $(elemento).removeClass("nao-preenchido");
            ...
            if (
                $(elemento).find("label > input[type='radio']:checked")
                    .length == 0
            ) {
                $(elemento).addClass("nao-preenchido");
                txtNPreenchidos++;
        ...
        $("#" + idPai + " .div_obrigatoria_span:visible").each(function(
            indice,
            elemento
        ) {
            $(elemento).removeClass("nao-preenchido");
            ...
            if (
                $(elemento).find("label > span > input[type='radio']:checked")
                    .length == 0
            ) {
                $(elemento).addClass("nao-preenchido");
                txtNPreenchidos++;
        ...
        $("#" + idPai + " .tabela-minimo-obrigatorio:visible").each(function(
            indice,
            elemento
        ) {
            $(elemento).removeClass("nao-preenchido");
        ...
        $("#" + idPai + " .minlength-obrigatorio:visible").each(function(
            indice,
            elemento
        ) {
            $(elemento).removeClass("nao-preenchido");
    ...
    exibeModalAviso: function(strTipo, strMensagem, strTitulo) {
        switch (strTipo) {
            ...
            case "sucesso":
                $("#lblTituloAviso").text(
                    strTitulo == null ? "SUCESSO!" : strTitulo
                );
            ...
            case "aviso":
                $("#lblTituloAviso").text(
                    strTitulo == null ? "AVISO!" : strTitulo
                );
    ...
    exibeAlerta: function(
        ...
        var mensagem =
            ...
            tipo +
            (permiteFechar ? " alert-dismissible" : "") +
            '" id="' +
            idAlerta +
            '" style="display: none;">';
    ...
    exibeCarregamento: function() {
        $(
            '<div id="div_overlay" class="sombra-carregamento"><div class="area" style="top: 45%; left: 48%; position: absolute; padding-bottom: 10px; padding-right: 10px;z-index: 9999999;"><img src="imagens/carregando.gif" id="Img1" style="width: 80px; height: 40px; background-color: white; border-radius: 5px;"></div></div>'
        ).prependTo("body");
    },
